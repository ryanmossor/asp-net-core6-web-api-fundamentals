...
namespace CityInfo.API.Services
{
    public class CityInfoRepository : ICityInfoRepository
    {
        ...
        public async Task AddPointOfInterestForCityAsync(int cityId, PointOfInterest pointOfInterest)
        {
            ...
            if (city != null)
                city.PointsOfInterest.Add(pointOfInterest); // only adds to object context; need to call SaveChangesAsync() to persist changes
        }
        ...
        public async Task<bool> SaveChangesAsync()
        {
            ...
            // For this demo, we want this method to return true when 0 or more entities have successfully been saved.
